...
class Juego:
    ...
    def update(self):
        ...
        # -------------------------------
        #   FIN DEL JUEGO POR 3 FALLOS
        # -------------------------------
        if self.fallos >= 3:
            self.game_over = True

        if self.game_over:
            return  # congelar el juego
        ...
        # Respawn automático si terminó reparto
        ...
        # Congelar juego mientras camión está fuera
    ...
    def draw(self):
        ...
        # Mensaje mientras camión está fuera
        if self.camion.estado == "fuera":
